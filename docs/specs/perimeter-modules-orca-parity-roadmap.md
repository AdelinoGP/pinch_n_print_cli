...
| T-092 | Remove all doc and spec stale forward-refs to `variable-width-perimeters` | `docs/**/*.md`, `.ralph/specs/**/*.md` | `rg variable-width-perimeters docs/ .ralph/specs/` returns zero hits outside deletion-noting entries. |
