...
|---|---|---|
| `precise_outer_wall` | DEFAULT-MISMATCH | No question covered it. Ticket 100 deliberately declined to flip it (the port's precise-outer-wall path changes wall ordering); recorded as DEV-195 (filed as DEV-158, renumbered in the merge resolution) and still open. |
