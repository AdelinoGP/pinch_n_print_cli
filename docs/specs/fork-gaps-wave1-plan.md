...
|---|-------------|---------------------|----------|------------|--------|------------|
| 1 | 166-nonuniform-scale-bake | Delete the dead validate_non_uniform_scale rejection (zero production call sites — grounding correction) and prove per-axis scale baking with tests + downstream audit. | TASK-272 (new) | - | generated | .ralph/specs/166-nonuniform-scale-bake |
