...
| 5 | visual-debug-agent-verification | Add the agent workflow and verify contract coverage, determinism, and zero ordinary-slice overhead. | TASK-271 | 159-visual-debug-intermediate-renderer; 160-visual-debug-gcode-renderer; ADR-0038 | generated | packet 161 (archived) |
