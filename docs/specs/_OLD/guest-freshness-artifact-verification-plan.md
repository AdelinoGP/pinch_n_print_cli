...
- Round 3 (mid-coder + reviewer): full-equality must scope to the exported
  ...
  docs/spec_packets/205 design.md:7<!-- VERIFY: "205 design.md" is ambiguous post-compaction — six 205-series packets exist as single files under docs/spec_packets/_OLD/ (205-editions-xtask-dist-ci, 205a through 205e); the per-packet design.md no longer exists as a separate file. Left as written; resolve to the specific compacted file if this breadcrumb is ever followed. -->).
