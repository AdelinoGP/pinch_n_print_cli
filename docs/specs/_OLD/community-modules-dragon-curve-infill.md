...
Status: grilling complete; ready to be broken into spec packets by a downstream session; Packet queue plan: `docs/specs/_OLD/community-modules-dragon-curve-plan.md`.
