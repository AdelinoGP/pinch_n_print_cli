...
| 122 | support-planner-multi-neighbour-mst | Replace single-neighbour propagation with all-neighbour target synthesis and symmetry coverage. | TASK-287 (renumbered from source-plan TASK-263; 1/d² aggregate) | 117, 119, 120, 121 | implemented (packet 122) | `.ralph/specs/122_support-planner-multi-neighbour-mst/` |
