...
wasm-tools component embed -w text-postprocess-module ../wit core.wasm -o embedded.wasm
wasm-tools component new --adapt "wasi_snapshot_preview1=$WASI_ADAPTER" -o comp.wasm embedded.wasm
