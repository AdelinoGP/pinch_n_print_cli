...
- `docs/spec_packets/core-brittle/packet.spec.md` - read-only predecessor boundary (ledger-row AC pattern) - purpose: accumulated-row format and gate-token conventions, never edited.
