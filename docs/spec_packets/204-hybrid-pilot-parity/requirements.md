...
- `docs/spec_packets/201-integrated-module-registry-tier5/packet.spec.md`, `docs/spec_packets/202-native-adapter-and-dispatch/packet.spec.md` — read-only, for FORWARD-DEP shapes. Never modify.
...
- Packet 202's `native_dispatch_parity_seam_tdd.rs` will not exist until 202 is implemented. Its shape must be read from `docs/spec_packets/202-native-adapter-and-dispatch/` at implementation time, not assumed.
