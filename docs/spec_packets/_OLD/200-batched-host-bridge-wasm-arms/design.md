...
- `docs/spec_packets/194-*` … `198-*` (parallel plan), `docs/07_implementation_status.md`, `CONTEXT.md`, `docs/specs/multi-edition-distribution-plan.md` (orchestrator-owned queue) — never edit.
