...
- **Schema-version bump**. If `docs/02_ir_schemas.md` policy requires registering the bump in `docs/DEVIATION_LOG.md`, that adds a small docs edit (Step 7 absorbs it).
