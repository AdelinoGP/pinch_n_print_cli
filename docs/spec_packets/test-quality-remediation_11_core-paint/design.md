...
- `docs/spec_packets/test-quality-remediation_10_core-retire/packet.spec.md` - read-only predecessor boundary - purpose: scope and ledger-style conformance, never edited.
