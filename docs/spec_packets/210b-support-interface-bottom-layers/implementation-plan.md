...
- Files allowed to edit (at most 3):
  - `docs/spec_packets/210b-support-interface-bottom-layers/design.md` (§Prerequisites only, and only to record a confirmed drift before stopping)
...
- Files explicitly out of bounds:
  ...
  - `docs/spec_packets/211-support-interface-bottom-layers/`, `docs/spec_packets/210a-support-planner-coord-t/` — never edited from this packet
...
- `docs/spec_packets/211-support-interface-bottom-layers/packet.spec.md` remains `status: superseded` and its directory untouched.
