...
- Files explicitly out of bounds:
  - `docs/spec_packets/203-*/design.md`, `docs/spec_packets/203-*/implementation-plan.md`, `docs/spec_packets/204-*/design.md`, `docs/spec_packets/204-*/implementation-plan.md` — `SUMMARY` dispatch only
...
- Authoritative docs:
  ...
  - `docs/spec_packets/204-hybrid-pilot-parity/packet.spec.md` — AC-7 and AC-N1 only
...
- Context cost: `S`
- Authoritative docs:
  - `docs/spec_packets/203-integrated-cli-provenance/packet.spec.md` — the `integrated-classic-perimeters` precedent this step extends
