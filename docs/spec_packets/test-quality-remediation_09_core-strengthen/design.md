...
- `docs/spec_packets/test-quality-remediation_08_core-beading-threshold-review/**` for edits; its exports are reconstructed only through the delegated summary.
