...
| 3 | Gap-register disposition ledger + mirror tokens | TASK-431, TASK-432 | TASK-431, TASK-432 | `docs/specs/support-parity-gap-register.md` G-01..G-24 |
...
- `TASK-429..TASK-440` allocated at authoring time from the orchestrator's queue state
  (236→TASK-344..352, 237→353..362, 238a→363..368, 238b→369..380, 238c→381..398, 399..408,
  240→409..418, 241→419..428). Re-derive immediately before Step 1 writes:
  `grep -oE "TASK-[0-9]{3}" docs/07_implementation_status.md | sort -u | tail -1`.
