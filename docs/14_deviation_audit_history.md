...
- **DEV-052** (2026-05-14): Paint data dropped on non-`NormalPart` rows. Registered and closed by Packet 56b (`56b_threemf-modifier-part-ir-routing`). See `docs/DEVIATION_LOG.md` row DEV-052.
