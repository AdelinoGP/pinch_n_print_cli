...
pub const STAGES: &[StageSpec] = &[
    ...
    StageSpec { method: "run_slice_postprocess",    stage_id: "Layer::SlicePostProcess",      wit_export: "run-slice-postprocess",    world_id: "slicer:world-layer@1.0.0",         trait_name: "LayerModule" },
    StageSpec { method: "run_perimeters",           stage_id: "Layer::Perimeters",            wit_export: "run-perimeters",           world_id: "slicer:world-layer@1.0.0",         trait_name: "LayerModule" },
    StageSpec { method: "run_wall_postprocess",     stage_id: "Layer::PerimetersPostProcess", wit_export: "run-wall-postprocess",     world_id: "slicer:world-layer@1.0.0",         trait_name: "LayerModule" },
    StageSpec { method: "run_infill",               stage_id: "Layer::Infill",                wit_export: "run-infill",               world_id: "slicer:world-layer@1.0.0",         trait_name: "LayerModule" },
    StageSpec { method: "run_infill_postprocess",   stage_id: "Layer::InfillPostProcess",     wit_export: "run-infill-postprocess",   world_id: "slicer:world-layer@1.0.0",         trait_name: "LayerModule" },
    StageSpec { method: "run_support",              stage_id: "Layer::Support",               wit_export: "run-support",              world_id: "slicer:world-layer@1.0.0",         trait_name: "LayerModule" },
    StageSpec { method: "run_support_postprocess",  stage_id: "Layer::SupportPostProcess",    wit_export: "run-support-postprocess",  world_id: "slicer:world-layer@1.0.0",         trait_name: "LayerModule" },
    StageSpec { method: "run_path_optimization",    stage_id: "Layer::PathOptimization",      wit_export: "run-path-optimization",    world_id: "slicer:world-layer@1.0.0",         trait_name: "LayerModule" },
    // ── Prepass world (slicer:world-prepass@1.0.0) ─────────────────────
    StageSpec { method: "run_mesh_segmentation",    stage_id: "PrePass::MeshSegmentation",    wit_export: "run-mesh-segmentation",    world_id: "slicer:world-prepass@1.0.0",       trait_name: "PrepassModule" },
    ...
    StageSpec { method: "run_gcode_postprocess",    stage_id: "PostPass::GCodePostProcess",   wit_export: "run-gcode-postprocess",    world_id: "slicer:world-postpass@1.0.0",      trait_name: "PostpassModule" },
    StageSpec { method: "run_text_postprocess",     stage_id: "PostPass::TextPostProcess",    wit_export: "run-text-postprocess",     world_id: "slicer:world-postpass@1.0.0",      trait_name: "PostpassModule" },
];
