...
///     points: vec![
///         Point3WithWidth { x: 0.0, y: 0.0, z: 0.0, width: 0.4, flow_factor: 1.0, overhang_quartile: None, dist_to_top_mm: 0.0 },
///         Point3WithWidth { x: 1.0, y: 0.0, z: 0.0, width: 0.4, flow_factor: 1.0, overhang_quartile: None, dist_to_top_mm: 0.0 },
///     ],
///     role: ExtrusionRole::SparseInfill,
///     speed_factor: 1.0,
/// };
...
/// let path = ExtrusionPath3D {
///     points: vec![
///         Point3WithWidth { x: 5.0, y: 5.0, z: 0.0, width: 0.4, flow_factor: 1.0, overhang_quartile: None, dist_to_top_mm: 0.0 },
///     ],
///     role: ExtrusionRole::SparseInfill,
///     speed_factor: 1.0,
/// };
...
///     points: vec![
///         Point3WithWidth { x: 0.0, y: 0.0, z: 0.0, width: 0.4, flow_factor: 1.0, overhang_quartile: None, dist_to_top_mm: 0.0 },
///         Point3WithWidth { x: 10.0, y: 0.0, z: 0.0, width: 0.4, flow_factor: 1.0, overhang_quartile: None, dist_to_top_mm: 0.0 },
///     ],
///     role: ExtrusionRole::SparseInfill,
///     speed_factor: 1.0,
/// };
...
///     points: vec![
///         Point3WithWidth { x: 0.0, y: 1.0, z: 0.0, width: 0.4, flow_factor: 1.0, overhang_quartile: None, dist_to_top_mm: 0.0 },
///         Point3WithWidth { x: 10.0, y: 1.0, z: 0.0, width: 0.4, flow_factor: 1.0, overhang_quartile: None, dist_to_top_mm: 0.0 },
///     ],
///     role: ExtrusionRole::SparseInfill,
///     speed_factor: 1.0,
/// };
