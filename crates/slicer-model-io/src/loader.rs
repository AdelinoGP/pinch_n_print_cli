...
/// height.
///
/// Uses [`object_world_z_extent`] to compute the world-space Z range and rejects
/// the object when its maximum Z exceeds `printable_height`.
///
/// Objects with no geometry or a degenerate extent are treated as valid.
///
