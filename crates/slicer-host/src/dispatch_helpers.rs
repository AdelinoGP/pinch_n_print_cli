...
/// Harvest the paint-region IR from an [`HostExecutionContext`] that has had
/// paint-region entries collected via [`HostPaintSegmentationOutput::push_paint_region`].
///
...
pub fn harvest_paint_segmentation_ir_from_ctx(ctx: HostExecutionContext) -> PaintRegionIR {
