...
//!
//! This test does not spin up any WASM — it only exercises the manifest-file
...
//! error-message assertions — they are left as-is by design.
...
// The runtime value is exactly "PrePass::Support" + "Generation" — the
...
description = "fixture — obsolete stage id"
author = "test"
license = "MIT"
...
/// The string literals in the body are intentional test inputs — see module doc.
#[test]
