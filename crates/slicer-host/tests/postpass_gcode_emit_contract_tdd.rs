...
// ============================================================================
// NoOpRunner — a passthrough runner that does nothing to GCodeIR or text
// ============================================================================

use slicer_host::{Blackboard, CompiledModule, PostpassOutput, PostpassStageRunner};
...
impl PostpassStageRunner for NoOpRunner {
    ...
    ) -> Result<PostpassOutput, slicer_host::PostpassError> {
...
fn full_postpass_pipeline_preserves_orca_emission_contract() {
    ...
    use slicer_host::execution_plan::ExecutionPlan;
    use slicer_host::postpass::execute_postpass;
    use slicer_host::{DefaultGCodeEmitter, DefaultGCodeSerializer};
    use std::sync::Arc;
