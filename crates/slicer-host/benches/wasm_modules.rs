...
//! IR fixture construction for every stage is left as v3 work — the
...
use slicer_host::manifest::load_module_from_paths;
use slicer_host::{export_name_for_stage, WasmEngine};
