...
pub use visual_debug_render::{
    ...
    render_silhouette_seam_overlay, silhouette_flow_width_mm, silhouette_seam_events,
    union_silhouette_intervals, GcodeEmitSegment, SilhouetteScheduleSlab, SilhouetteSlabSchedule,
    SilhouetteView,
};
