...
//! `#[slicer_module]` â€” no hand-rolled `wit_bindgen::generate!` or
...
// â”€â”€ Finalization world â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Prepass world (MeshAnalysis) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Blocker-#2 content witnesses â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
fn layer_world_macro_guest_sees_real_slice_region_content() {
    ...
    assert!(
        ...
        "typed deep copy IN must forward all 6 polygons (2 regions Ã— 3): {msg}"
    );
    assert!(
...
// â”€â”€ Custom payload round-trip tests (TASK-150) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

/// Round-trip test for ExtrusionRole::Custom(String).
///
/// Tests that a custom extrusion role payload survives the WIT boundary:
/// IR (ExtrusionRole::Custom) â†’ WIT (ExtrusionRole::Custom) â†’ IR (ExtrusionRole::Custom)
///
/// Note: The IRâ†’WIT direction uses inline conversion logic that mirrors the
/// macro's private __slicer_ir_role_to_wit function, since that function is
/// not accessible from tests. The WITâ†’IR direction uses the public
...
fn extrusion_role_custom_payload_roundtrip() {
    ...
    // Step 2: Convert IR â†’ WIT using inline logic (mirrors macro's __slicer_ir_role_to_wit)
...
/// Uses inline conversion logic for IRâ†’WIT since the host's ir_to_wit_paint_semantic
/// is private. The WITâ†’IR direction uses the public convert_wall_feature_flag
...
fn wall_feature_flags_custom_payload_roundtrip() {
    ...
    // Convert WIT â†’ IR using public convert_wall_feature_flag
