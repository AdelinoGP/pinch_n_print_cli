...
fn integrated_parity_skirt_brim() {
    ...
    let wasm_module = CompiledModuleBuilder::new("com.core.skirt-brim")
        .config_view(Arc::clone(&config))
        .build();
    let native_module = CompiledModuleBuilder::new("com.core.skirt-brim")
        .config_view(config)
        .build();
    ...
    .with_native_entry(SkirtBrim::__slicer_native_entry());
