...
fn integrated_parity_gyroid_infill() {
    ...
    let wasm_module = CompiledModuleBuilder::new("com.core.gyroid-infill")
        .claims(vec![
        ...
        .build();
    let native_module = CompiledModuleBuilder::new("com.core.gyroid-infill")
        .claims(vec![
            "claim:sparse-fill".to_string(),
            "claim:top-fill".to_string(),
            "claim:bottom-fill".to_string(),
    ...
    .with_native_entry(GyroidInfill::__slicer_native_entry());
