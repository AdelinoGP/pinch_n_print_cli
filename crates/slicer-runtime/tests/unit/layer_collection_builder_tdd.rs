...
//!
//! Covers TASK-152g (packet 32 â€” `layer-collection-builder` WIT surface).
...
fn three_entity_arena() -> LayerArena {
    // Raw start-x: [30.0, 0.0, 10.0] â€” the same fixture shape as the
...
// â”€â”€ Positive path: permutation applied â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
fn valid_permutation_is_applied_to_ordered_entities() {
    ...
    // moves slot-2 (x=10) â†’ first, slot-0 (x=30) â†’ second, slot-1 (x=0) â†’ third.
...
// â”€â”€ Reversal flag: per-entity Vec::reverse() on path.points â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Negative: duplicate index in proposal â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Negative: out-of-range index â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Negative: wrong-length proposal â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Negative: arena has no LayerCollectionIR staged â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Read side: project_ordered_entities snapshot projection â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Atomicity: malformed proposal leaves ordered_entities unchanged â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Macro-call-once contract: multi-read guest exercises 5 SDK reads â”€â”€â”€â”€â”€â”€â”€â”€â”€

const MULTI_READ_GUEST_COMPONENT: &str = concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/../slicer-wasm-host/test-guests/path-optimization-multi-read.component.wasm"
);
...
impl<'a> slicer_runtime::LayerStageRunner for PerimeterSeedingRunner<'a> {
    fn run_stage(
        &self,
