//! Acceptance-gate gap closure (docs/11 Â§3 Gate Rubric, docs/12 metrics).
//!
//! Each test category below corresponds to one row of the docs/11 Â§3 gate
//! rubric or one bound from docs/12 Â§Resource Bounds / Â§Operability.
...
use slicer_runtime::{
    ...
    ModuleAccessAudit, Producer, SchedulerError, StageDag, WasmArtifactMetadata,
};

// â”€â”€ Shared fixtures â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Determinism: instance pool isolation/serialization/concurrency â”€â”€â”€â”€â”€â”€
// docs/12 Â§Determinism + docs/04 instance-pool contract.
...
fn parallel_safe_module_returns_distinct_slot_indices_across_threads() {
    ...
    // Concurrent re-acquisition must still terminate (no deadlock) â€” exercise
...
// â”€â”€ Operability: required progress-event set per slice â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
// docs/12 Â§Operability "Required event set present for each run".
...
fn json_lines_emitter_preserves_event_order_and_one_event_per_line() {
    ...
    // Ordering preserved: layer_start precedes layer_complete (docs/11 Â§74).
    let ls_pos = text.find("layer_start").unwrap();
    let lc_pos = text.find("layer_complete").unwrap();
    assert!(ls_pos < lc_pos);
}

// â”€â”€ Recoverability: structured ProgressError variants serialize â”€â”€â”€â”€â”€â”€â”€â”€â”€
// docs/11 Â§74 + docs/04 Â§770-775.
