//! TDD red tests for TASK-095: traditional-support enforcer/blocker paint semantics.
//!
//! Tests verify that traditional-support reads PaintRegionIR for SupportEnforcer
...
//! - OrcaSlicerDocumented/src/libslic3r/Support/SupportMaterial.cpp:1673-1682 (blocker diff)
//! - OrcaSlicerDocumented/src/libslic3r/Support/SupportMaterial.cpp:1740-1749 (enforcer projection)
...
/// Enforcer overrides `needs_support=false`.
#[test]
...
/// Blocker still wins even when `needs_support=true`.
#[test]
