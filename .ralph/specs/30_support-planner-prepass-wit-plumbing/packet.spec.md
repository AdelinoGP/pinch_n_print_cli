...
- **Depends on:** Packet `28_tree-support-multi-layer-propagation` (introduces the `support-planner` crate, `PrePass::SupportGeneration` stage, and `SupportPlanIR` blackboard slot this packet extends). **Status: implemented** ✓
