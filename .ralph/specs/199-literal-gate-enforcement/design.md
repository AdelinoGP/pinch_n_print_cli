...
- `.ralph/specs/194-check-literals-gate/packet.spec.md` and `198-literal-sweep-sdk-modules/packet.spec.md` - purpose: consumed export contracts (CLI shape, sdk `--features test` facts) if the exports ledger needs re-confirmation.
