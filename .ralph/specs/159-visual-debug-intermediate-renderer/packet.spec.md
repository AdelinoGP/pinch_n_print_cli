...
copy_note: Packet 158 is generated/draft; its renderer-owned capture export is a forward contract and must be confirmed before implementation.
---
...
- Depends on: packet `158-visual-debug-typed-tap-capture`; the `png` dependency decision and packet-158 renderer-owned capture export.
