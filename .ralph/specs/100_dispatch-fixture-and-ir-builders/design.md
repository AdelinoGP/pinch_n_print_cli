...
- Exact functions, traits, manifests, tests, or fixtures expected to change:
  - NEW: `crates/slicer-runtime/tests/common/dispatch_fixture.rs` — `pub struct DispatchFixture`, `pub struct DispatchFixtureBuilder`, `impl DispatchFixtureBuilder { fn for_stage, fn with_slice, fn with_perimeter, fn with_config, fn with_wat, fn no_wasm, fn build }`, `impl DispatchFixture { fn run_layer, fn run_prepass, fn run_finalization, fn run_postpass }`.
