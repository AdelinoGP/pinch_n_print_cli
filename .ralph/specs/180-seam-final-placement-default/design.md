...
- At packet 180 close, amend `docs/adr/0046-aligned-seam-in-seam-planning-prepass.md` L50 and L97-98 to reflect the new default; append a one-paragraph rationale at the end of the ADR documenting the amendment (date, decision, citation of the `ADR-0046 amendment` record).
