# Task Map: 117-arachne-transition-ends-and-extra-ribs
...
| M2 — P116a/P116b (no TASK-###) | 116a/116b | draft → implemented | B depends on A1/A2's junction fans + emission. |
...
| `D-117-TRANSITION-ENDS` (NEW) | — | B creates this entry documenting the N3+N8 fix. |
| `D-116A-JUNCTION-BANDS` / `D-116B-CONNECTJUNCTIONS-EMISSION` | Closed (A1/A2) | Untouched by B (B reads A1/A2's output but doesn't change them). |
