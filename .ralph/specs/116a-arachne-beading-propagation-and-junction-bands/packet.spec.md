---
status: draft
packet: 116a-arachne-beading-propagation-and-junction-bands
task_ids:
  - none
...
# Packet Contract: 116a-arachne-beading-propagation-and-junction-bands
...
- Depends on: `113c-arachne-faithful-graph-construction` (`status: implemented`)
  ...
  generation walks.
- Unblocks: `116b-arachne-canonical-connectjunctions-emission` (N2+N4 — needs
  A1's correct junction fans for the `perimeter_index` pop-back merge); `117-arachne-transition-ends-and-extra-ribs` (N3+N8 — B's beading interpolation reads
  A1's junction fans); `118-arachne-angle-fudge-and-noncentral-regions` (N5+N6 —
...
- `docs/DEVIATION_LOG.md` — new entry `D-116A-JUNCTION-BANDS` documenting the
  ...
  - `rg -q 'D-116A-JUNCTION-BANDS' docs/DEVIATION_LOG.md`
  - `rg -q 'D-116A-JUNCTION-BANDS' docs/DEVIATION_LOG.md && rg -q 'inherited.*116A\|116A.*inherit' docs/DEVIATION_LOG.md`
