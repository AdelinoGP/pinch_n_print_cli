...
- **Deviations**:
  ...
  - (f) `docs/adr/0022-overhang-classification-at-prepass.md`, cited by this packet, does not exist in tree (P106 closure gap — flagged upstream, not fixed here). *[Resolved post-close, 2026-07-02 review: the ADR exists but landed at slot 0031 — `docs/adr/0031-overhang-classification-at-prepass.md`; slot 0022 was taken by packet 127's per-region-origin ADR before P106 shipped. Live docs repointed.]*
