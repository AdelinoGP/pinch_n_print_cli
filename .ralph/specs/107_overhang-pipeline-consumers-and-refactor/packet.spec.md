...
- `docs/DEVIATION_LOG.md` — close D-10, D-12, D-OVERHANG-QUARTILE-NONE — `rg -q 'D-10.*closed\|D-10.*resolved' docs/DEVIATION_LOG.md && rg -q 'OVERHANG-QUARTILE-NONE.*closed\|OVERHANG-QUARTILE-NONE.*resolved' docs/DEVIATION_LOG.md`
- `docs/specs/perimeter-modules-orca-parity-roadmap.md` — mark T-024 and T-077 as unblocked — `rg -q 'T-024.*unblocked\|T-024.*preconditions met' docs/specs/perimeter-modules-orca-parity-roadmap.md && rg -q 'T-077.*unblocked\|T-077.*preconditions met' docs/specs/perimeter-modules-orca-parity-roadmap.md`
