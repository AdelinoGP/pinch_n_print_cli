...
- `.ralph/specs/194-*`, `195-*`, `196-*`, `docs/07_implementation_status.md`, `CONTEXT.md`, `docs/specs/multi-edition-distribution-plan.md` — never edit. `docs/adr/*` — never edit **except** the ADR-0005 amendment carved out below.
