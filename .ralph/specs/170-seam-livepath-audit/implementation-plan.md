...
- Postcondition: the file compiles and all four tests run to a verdict; each test's identity-comparison covers `path.points`, `feature_flags`, `width_profile.widths`, and the closing-repeat convention (last point equals first point).
