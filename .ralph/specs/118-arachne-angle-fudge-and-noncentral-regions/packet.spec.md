---
status: draft
packet: 118-arachne-angle-fudge-and-noncentral-regions
task_ids:
  - none
...
# Packet Contract: 118-arachne-angle-fudge-and-noncentral-regions
...
- Depends on: `116b-arachne-canonical-connectjunctions-emission` (A2) strictly — the π hack is load-bearing for A1's centrality-gated scheme until A1/A2 land; C removes it strictly after A2.
...
- `docs/DEVIATION_LOG.md` `D-116A-JUNCTION-BANDS` entry — read full; addendum target.

## Doc Impact Statement

A list of specific doc sections that this packet adds or modifies:

- `docs/DEVIATION_LOG.md` — new entry `D-118-ANGLE-FUDGE-NONCENTRAL` documenting the N5+N6 fix, with an addendum on `D-116A-JUNCTION-BANDS` noting C removes the π hack A1 left in place. Supersession pattern.
  - `rg -q 'D-118-ANGLE-FUDGE-NONCENTRAL' docs/DEVIATION_LOG.md`
