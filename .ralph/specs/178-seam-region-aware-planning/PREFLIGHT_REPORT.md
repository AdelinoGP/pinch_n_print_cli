...
| **S2** Deviation-ID conformance | PASS | The historical `seam source-geometry deviation` label is absent after the purge; ADR-0046 remains the surviving aligned-seam decision record. | — |
