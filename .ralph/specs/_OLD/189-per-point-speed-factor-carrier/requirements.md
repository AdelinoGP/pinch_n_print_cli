...
- `crates/slicer-schema/wit/deps/finalization-layer-finalization/finalization-layer-finalization.wit`: additive `set-point-speed-factors(list<f32>)` case on `variant entity-mutation`.
