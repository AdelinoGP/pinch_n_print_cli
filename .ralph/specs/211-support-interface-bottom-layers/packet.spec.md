...
> re-split the same day into `.ralph/specs/210a-support-planner-coord-t/` (DEV-128, the
> coord_t migration + the `split_column_into_chains` extraction) and
> `.ralph/specs/210b-support-interface-bottom-layers/` (DEV-129, this packet's successor).**
>
...
> `.ralph/specs/210a-support-planner-coord-t/requirements.md` (historical reference: this named the merged `210` at the time of writing)
