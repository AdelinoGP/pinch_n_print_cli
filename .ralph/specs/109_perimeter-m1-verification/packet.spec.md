...
- `docs/02_ir_schemas.md` §"Schema Versioning" — record the schema bump (from the live `4.3.0` base, plus any prior bumps from P105) as additive removal of `external_contour`; do not hardcode the target version — `rg -q 'external_contour.*removed\|removed.*external_contour' docs/02_ir_schemas.md`
