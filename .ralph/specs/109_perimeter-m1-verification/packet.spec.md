...
- `docs/02_ir_schemas.md` §"Schema Versioning" — record the 4.5.0 → 4.6.0 bump as additive removal of `external_contour` — `rg -q '4\.6\.0.*external_contour|external_contour.*removed.*4\.6\.0' docs/02_ir_schemas.md`
