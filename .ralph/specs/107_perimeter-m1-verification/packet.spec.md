---
status: draft
packet: 107_perimeter-m1-verification
task_ids:
  - T-100
  - T-101
  - T-102
...
# Packet Contract: 107_perimeter-m1-verification
...
- Depends on:
  - **P102, P103, P104, P105, P106** — all M1 implementation packets must be `status: implemented` before this packet's parity harness can record meaningful baselines.
- Unblocks:
...
- `docs/07_implementation_status.md` — mark Classic parity (M1) complete with packet IDs P102..P107 listed — `rg -q 'M1.*Classic parity.*complete\|Classic parity complete.*P102.*P103.*P104.*P105.*P106.*P107' docs/07_implementation_status.md`
